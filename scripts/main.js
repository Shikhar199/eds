...
if (window.$jq && window.Slick) {
    ...
    //   });
      ...
      $jq('.item').click(function () {
        ...
        var goToThisIndex = $jq(this).children("span.progressBar").data("slickIndex");
        $jq('.single-item').slick('slickGoTo', goToThisIndex, false);
        startProgressbar();
      });
      
      
      $jq('.banner-slick').slick({
        dots: false,
        speed: 800,
        slidesToShow: 4,
        slidesToScroll: 4,
