...
async function loadBlock(block) {
  ...
  if (status !== 'loading' && status !== 'loaded') {
    ...
    if(window.location.href.includes("local")){
      CSSFilePath = `${window.hlx.codeBasePath}/blocks/${confluenceSite}/${blockName}/${blockName}.css`;
      JSFilePath = `${window.hlx.codeBasePath}/blocks/${confluenceSite}/${blockName}/${blockName}.js`;
    } else{
